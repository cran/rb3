...
codes.
After the business days and implied rates are calculated with the
`fixedincome::rates` function, once we know that the notional amount of
these contracts is 100000.
